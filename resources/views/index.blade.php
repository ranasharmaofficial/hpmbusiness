...
@section('title')Home - Agrina Crop Care @endsection

@section('description')Agrina Crop Care @endsection
...
<div class="slideshow-container" id="hero">
            <div class="slideshow" data-flex-fullscreen="true">
                <ul class="slides">
                    <li>
                        <img src="{{url('front_assets/img/slideshow/slider-1.jpg')}}" data-position-y="top" alt="Slideshow Image">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <p class="hero-caption no-margin flex-animate" data-animate="animate__fadeInDown">Do you need to help for maintenance of your garden</p>
                                            <hr class="hero-separator flex-animate" data-animate="animate__fadeInDown" data-animate-delay="500">
                                            <h1 class="hero-heading flex-animate" data-animate="animate__fadeInDown" data-animate-delay="650">Complete Care<br>For All Your Landscape Needs</h1>
                                            <a href="#" class="btn btn-default flex-animate" data-animate="animate__fadeInLeft" data-animate-delay="1000">Get In Touch</a>
                                            <a href="#" class="btn btn-white btn-border flex-animate" data-animate="animate__fadeInRight" data-animate-delay="1000">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li>
                        <img src="{{url('front_assets/img/slideshow/slider-2.jpg')}}" alt="Slideshow Image">
                        <div class="flex-content-overlay"></div>
                        <div class="flex-content-wrapper">
                            <div class="flex-content">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <p class="hero-caption no-margin flex-animate" data-animate="animate__fadeInDown">We can help to create the garden of your dreams</p>
                                            <hr class="hero-separator flex-animate" data-animate="animate__fadeInDown" data-animate-delay="500">
                                            <h1 class="hero-heading flex-animate" data-animate="animate__fadeInDown" data-animate-delay="650">Easy to Set up, Easy to Fill<br>and Easy to Grow</h1>
                                            <a href="#" class="btn btn-default flex-animate" data-animate="animate__fadeInLeft" data-animate-delay="1000">Get In Touch</a>
                                            <a href="#" class="btn btn-white btn-border flex-animate" data-animate="animate__fadeInRight" data-animate-delay="1000">Learn More</a>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <img src="{{url('front_assets/img/slideshow/slider-3.jpg')}}" data-position-y="top" alt="Slideshow Image">
                        <div class="flex-content-overlay"></div>
                        <div class="flex-content-wrapper">
                            <div class="flex-content">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <p class="hero-caption no-margin flex-animate" data-animate="animate__fadeInDown">Now you don't have to bother thinking about design</p>
                                            <hr class="hero-separator flex-animate" data-animate="animate__fadeInDown" data-animate-delay="500">
                                            <h1 class="hero-heading flex-animate" data-animate="animate__fadeInDown" data-animate-delay="650">We Can Create An Environment<br>That's Beyond Your Imagination</h1>
                                            <a href="#" class="btn btn-default flex-animate" data-animate="animate__fadeInLeft" data-animate-delay="1000">Get In Touch</a>
                                            <a href="#" class="btn btn-white btn-border flex-animate" data-animate="animate__fadeInRight" data-animate-delay="1000">Learn More</a>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 text-center">
                        ...
                        <h2>Agrina Crop Care have Experience<br>In All Aspects of Garden Maintenance</h2>
                        <p class="gap" data-gap-bottom="30">
                            We have a lot of experience in garden services and landscape design, We offer professional services from planting, maintenance and design of your garden. We also provide regular garden maintenance, decoration and
                            landscaping, stone hardscaping, design and planting, garden clearance, watering plants or complete design of your garden. Don't be afraid if you have any problems, please contact us for a free consultation
                        </p>
        ...
        <section class="section" id="why-choose-us">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heading-title text-center">
                            <h3>Why <strong class="text-color">Choose Us?</strong></h3>
                            <p class="lead">See the benefits you can get by working with our experts</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="feature icon-right">
                            ...
                            <div class="feature-content">
                                <h5>Eco Friendly &amp; Naturally Sourced Materials</h5>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="feature icon-right">
                            ...
                            <div class="feature-content">
                                <h5>Full Design &amp; Planning Service</h5>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="feature icon-right">
                            <i class="craftico-cup-of-tea-and-books"></i>
                            <div class="feature-content">
                                <h5>Professional &amp; Have Many Experience</h5>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="feature icon-right">
                            ...
                            <div class="feature-content">
                                <h5>Large Portfolio of Happy Customers</h5>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="feature icon-right">
                            ...
                            <div class="feature-content">
                                <h5>Free Monthly Garden Magazine</h5>
                        ...
                        <ul class="testimonial-carousel content-contrast">
                            ...
                            <li>
                                <div class="testimonial">
                                    <blockquote>
                                        <p>
                                            Agrina Crop Care listened to our requirements when we needed to landscape our garden following a house extension. He presented several options. with a patiently designed hybrid solution diligently
                                            executed
                                        </p>
                                        <cite>
                            ...
                            <li>
                                <div class="testimonial">
                                    <blockquote>
                                        <p>
                                            Agrina Crop Care team has designed and created a wonderful garden landscape for my new office. The workmanship and the materials used are all first class and Agrina Crop Care team are passionate about follow up
                                            garden maintenance
                                        </p>
                                        <cite>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <p>Over 300 projects with high level of customer satisfaction, winning multiple awards in various aspects of the landscape and garden design, we always provide the best service to customers.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p>Agrina Crop Care is Garden Company, provides all you need about Garden and Landscape Design.</p>
