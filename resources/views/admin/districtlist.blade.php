            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header bg-danger rounded">
                        ...
                        <p class="p-0 m-0 text-white">Total Data: <b>{{$district->total();}}</b>, Page No: <b>{{$district->currentPage();}}</b></p>
                    </div>
...
<form method="get" style="float: right;">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
								...
								<tr>
									<td>{{($district->currentpage()-1) * $district->perpage() + $key + 1}}</td>
									<td>{{$data->name}}</td>
									{{--<td>{{$data->created_at->format('d-m-Y')}}</td>--}}
									<td><a href="{{url('admin/edit-district/'.$data->id_district)}}" class="me-3 text-primary" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" aria-label="Edit"><i class="mdi mdi-pencil font-size-18"></i></a></td>
