            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header bg-danger rounded">
                        ...
                        <p class="p-0 m-0 text-white">Total Teacher: <b>{{$teachers->total();}}</b>, Page No: <b>{{$teachers->currentPage();}}</b></p>
                    </div>
                    <div class="card-body table-responsive">                        
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                            @forelse ($teachers as $key => $data)
                            <tr>
                                <td>{{($teachers->currentpage()-1) * $teachers->perpage() + $key + 1}}</td>
                            ...
                            @empty
                                <tr class="text-center text-danger">
                                    <td colspan="7">Realated Data Not Available</td>
                                </tr>
                            @endforelse
