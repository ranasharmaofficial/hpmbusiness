        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="post" action="{{route('updateDistributorData')}}" enctype="multipart/form-data" class="card-body">
                        @csrf
                        <input type="hidden" name="distributorid" value="{{$distdata->user_id}}" required />
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" type="text" required name="name" value="{{$distudata->name}}" placeholder="Enter Full Name" id="fullname">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" type="date" required name="dob" value="{{$distdata->dob}}" id="dob">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select id="BatchTiming" name="gender" required class="form-select" aria-label="Select Gender">
                                        <option selected value="{{$distdata->gender}}">{{$distdata->gender}}</option>
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required name="landmark" value="{{$distdata->landmark}}" placeholder="Landmark" id="landmark" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required type="tel" name="pincode" value="{{$distdata->pincode}}" placeholder="Enter Pin code" id="pincode">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required type="tel" name="mobile_no" value="{{$distudata->mobile}}" placeholder="Enter Mobile No." id="mobileNumber">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" type="tel" name="alt_mobile_no" value="{{$distdata->alt_mobile}}" placeholder="Enter Alt. Mobile No." id="AltMobile">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required type="email" name="email" value="{{$distudata->email}}" placeholder="Enter Email" id="email">
                                    <small class="form-text text-danger">@error('email') {{$message}} @enderror</small>
                                </div>
                                <div class="col-sm-12 text-center mt-3">
                                    <button name="update_distributor" type="submit" class="btn btn-danger"><i class="fa fa-save"></i> Update Distributor Data</button>    
                                </div>                                
                            </div>
                        </div>                         
                    </form>
