            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header bg-danger rounded">
                        ...
                        <p class="p-0 m-0 text-white">Total Data: <b>{{$worklist->total();}}</b>, Page No: <b>{{$worklist->currentPage();}}</b></p>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-success btn-sm" type="button">Payment Received</button>
                                      {{-- <form action="{{route('admin.work-details.{}')}}" method="get" class="d-inline">  
                                        @csrf
                                        <input type="text" value="{{$data->id}}" name="workid" required>  --}}
